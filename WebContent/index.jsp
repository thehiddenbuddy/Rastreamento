...
<script>if(!RVBD_EUE_PARAM){var RVBD_EUE_PARAM={};} RVBD_EUE_PARAM.pageId = 'a2_56d901dc-f81e-425b-81df-4f5c6c61cc92';</script>             
<!-- AppInternalsXpert BMX Integration End -->
<script type="text/javascript"> 
pageid = '1C176412-5056-9163-899EFCAC123FCB77'; 
</script>
<noscript>
...
<!-- scripts --><noscript><p>Biblioteca de efeitos</p></noscript> 
  <script type="text/javascript" src="home2014/js/jquery-1.6.2.min.js"></script>
    <noscript><p>Biblioteca de efeitos para menus</p></noscript> 
  <script type="text/javascript" src="home2014/js/ddaccordion.js"></script>
    <noscript><p>Biblioteca de efeitos para tabbes</p></noscript> 
  <script type="text/javascript" src="home2014/js/jtabber.js"></script>
    <noscript><p>Biblioteca de efeitos colorbox</p></noscript> 
  <script type="text/javascript" src="home2014/js/jquery.colorbox-min.js"></script>
   <noscript><p>Biblioteca de validação de formulários</p></noscript> 
  <script type="text/javascript" src="home2014/js/validations.js"></script>

  <noscript><p>Script Javascript</p></noscript>
  <script type="text/javascript" src="home2014/js/scripts.js"></script>
  <noscript><p>Script Javascript</p></noscript>   
  <script type="text/javascript" src="home2014/js/cookie.js"></script>
    <noscript><p></p>Script Javascript</noscript>   
<script type="text/javascript">document.documentElement.className += " js";</script>
  <noscript><p>Controle de abas</p></noscript>
 <noscript><p>Biblioteca de animações</p></noscript> 
...
<div class="acesso_rapido">
  ...
  <div class="text-right">
    ...
    <a href="http://www.correios.com.br/sobre-correios/fale-com-os-correios/fc">Fale com os Correios</a><br/>
  </div>
...
<h3>Rastreamento<span style="font-weight:lighter"> por objeto ou </span>CPF/CNPJ*</h3>
</div>
<div class="msg">

</div>
<div class="quadroavisos">
SEDEX 12 e do SEDEX Hoje, representa o hor&aacute;rio real da entrega.</p><p>As informa&ccedil;&otilde;es de rastro de objetos registrados ficar&atilde;o dispon&iacute;veis at&eacute; 180 dias ap&oacute;s a data de postagem.</p><h4>Objetos com origem ou destino fora do Brasil</h4><p>O rastreamento para objetos postados no Brasil com c&oacute;digo iniciado por "R" e "C" e terminado com "BR" n&atilde;o &eacute; garantido fora do territ&oacute;rio brasileiro.</p><p>Para esses objetos, os operadores postais de outros pa&iacute;ses podem n&atilde;o disponibilizar e/ou transmitir informa&ccedil;&atilde;o de rastreamento para o Brasil.</p><p>Sendo assim, consultas de rastreamento de objetos podem tamb&eacute;m ser realizadas nos sites dos operadores de destino dispon&iacute;veis no site da UPU - Uni&atilde;o Postal Universal.</p><p><b>Para os objetos postados no Exterior para o Brasil</b>, o servi&ccedil;o contratado pelo remetente na origem determina o n&iacute;vel de informa&ccedil;&atilde;o de rastreamento de objetos em nosso site.</p><p>Objetos registrados recebidos do exterior que apresentam c&oacute;digo iniciado por "R" n&atilde;o pertencem &agrave; modalidade expressa, sem rastreamento ponto a ponto, ou seja, as informa&ccedil;&otilde;es no sistema de rastreamento incluem apenas os eventos de: recebimento no Brasil e entrega, tentativa de entrega ou aguardando retirada na unidade respons&aacute;vel.</p><p>Em alguns casos, pode haver os eventos de encaminhamento para "fiscaliza&ccedil;&atilde;o" e "tributa&ccedil;&atilde;o" e "sa&iacute;da da fiscaliza&ccedil;&atilde;o", cujo prazo estimado de entrega &eacute; de 40 DIAS &Uacute;TEIS a partir da libera&ccedil;&atilde;o na alf&acirc;ndega.</p>
            <p>Remessas iniciadas com o c&oacute;digo "UM" n&atilde;o s&atilde;o rastre&aacute;veis no Brasil. Esse c&oacute;digo &eacute; utilizado pelo pa&iacute;s de origem para indicar que a remessa &eacute; pass&iacute;vel de pagamento de imposto de importa&ccedil;&atilde;o no destino.</p>
</div>
...
<script type="text/javascript">
		...
		tipoAlerta  = 'alert';
		tipoErro  = 'error';
		tipoInfo  = 'information';
		tipoSucesso  = 'success';
		
		// Mensagens --->
		msgInvalido  = "O(s) código(s) ou CPF/CNPJ estão inválidos";
		msgVazio  = "Por favor, digite de um a 50 códigos de objetos, ou um CPF/CNPJ válido";				
		msgMax50  = "Por favor, digite de um a 50 códigos de objetos, ou um CPF/CNPJ válido";
		msgNaoEncontradoPFouNPJ  = "Não encontramos objetos associados ao CPF/CNPJ registrados postados nos Correios";				
		msgPFouNPJInfoDifere  = "Documento informado diferente do documento do usuário logado. Para buscar com novo documento efetue novo login";
		msgPFouNPJcadImcompleto  = "Dados do usuário estão incompletos no Cadastro.";				
		msgErroRecuperarObjetos  = "Erro ao recuperar objetos associados ao CPF/CNPJ informado <BR /> Favor tentar mais tarde.";
		msgParaUsuariosInternos = "Funcionalidade disponível somente para usuários EXTERNOS <a href='sistemas/rastreamento/logout.cfm'>[Sair]</a>";
		msgInstrucao = "Consulte a situação de seus objetos nos Correios. Digite seu CPF/CNPJ ou at&eacute; 50 c&oacute;digos de 13 d&iacute;gitos cada, separando-os com ponto e v&iacute;rgula. Ex: AA123456789BR;AA987654321BR;AA100833276BR.";
		msgObsLogin = "*Para consultas por CPF/CNPJ, será requisitado efetuar login no idCorreios.";
		msgSemObjsDespPostal	= "Selecione algum objeto para realizar o pagamento";
...
<fieldset>
<label>Consulte a situação de seus objetos nos Correios. Digite seu CPF/CNPJ ou at&eacute; 50 c&oacute;digos de 13 d&iacute;gitos cada, separando-os com ponto e v&iacute;rgula. Ex: AA123456789BR;AA987654321BR;AA100833276BR.<br />
...
<span>*Para consultas por CPF/CNPJ, será requisitado efetuar login no idCorreios.</span>
...
<p>Caso seja de interesse, verifique se o seu objeto est&aacute; destinado a uma <a href="sistemas/precosPrazos/restricaoentrega/">&aacute;rea com restri&ccedil;&atilde;o de entrega domiciliar</a></p>
...
<div class="footer">
  <div class="wrap">
      ...
      <div class="column-footer">
        <h3><a href="sistemas/falecomoscorreios">Fale com os Correios</a></h3>
        <ul>
	...
	cbDivMouseOut();
		...
		$.jtabber({
			...
			$(document).ready(function(){
				...
				$(".inline2").colorbox({inline:true, width:"340px"});
				$(".inline3").colorbox({inline:true, width:"70%"});
				$(".callbacks").colorbox({
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-564464-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-564464-1');
</script>
...
<!-- contentobjects: page generated at 2018-09-27 10:23 AM -->
